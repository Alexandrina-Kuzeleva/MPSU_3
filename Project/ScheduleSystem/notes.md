...
2. Rooms:
   ...
   * `sched room update <id|code> [--code] [--capacity] ...` 70
...
6. Sessions (основная часть):
   ...
   * `sched session list [--group GROUP|--teacher TEACHER|--room ROOM|--date DATE|--from DATE --to DATE] [--conflicts-only]` 70
